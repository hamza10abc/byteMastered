            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                <div class="flex justify-between mb-4 items-start">
                    <div class="font-medium">
                        <h2 class="text-xl">
                            Add Product Arksaji - <i> <mark><?= $productName ?></mark></i>
                        </h2>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<tr class='text-gray-700 dark:text-gray-100'>
                                ...
                                <td class='border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4'>
                                    <a href='editRawMatCost.php?pid=" . $productFetchID . "&rmid=" . $rawMatID . "&page=" . 'As' . "&updateType=" . $updateType . "'>
                                    ...
                                    <a href='delRawMatCost.php?pid=" . $productFetchID . "&rmid=" . $rawMatID . "&page=" . 'As' . "'>
