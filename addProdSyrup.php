        ...
        <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md lg:col-span-3">
            ...
            <div class="flex justify-between mb-4 items-start">
                <div class="font-medium">
                    <h2 class="text-xl">
                        Add Product Syrup - <i> <mark><?= $productName ?></mark></i>
                    </h2>
                </div>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<tr class='text-gray-700 dark:text-gray-100'>
                                ...
                                <td class='border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4'>
                                    <a href='editRawMatCost.php?pid=" . $productFetchID . "&rmid=" . $rawMatID . "&page=" . 'S' . "'>
                                    ...
                                    <a href='delRawMatCost.php?pid=" . $productFetchID . "&rmid=" . $rawMatID . "&page=" . 'S' . "'>
