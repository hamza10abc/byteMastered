...
$idDawa = $_GET['id'];
$sql = "SELECT * from dawasaji where _id = $idDawa";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE `dawasaji` SET `noe` = '$noe', `nod` = '$nod', `salPerDay` = '$salPerDay' WHERE `dawasaji`.`_id` = $idDawa";
    $result = mysqli_query($conn, $sql);
    if ($result) {
        $update = true;
    } else {
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md lg:col-span-3">
            ...
            <div>
                ...
                <form action="editDawa.php?id=<?=$idDawa?>" method="post">
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" step="any" step="any" id="nod" name="nod" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123.00" value=<?= $nod ?> required />
                    </div>
                    <div class="mb-6">
